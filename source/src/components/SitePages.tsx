  ...
  return <div className="portfolio-shell library-shell">
    ...
    <main className="library-page">
      ...
      <section className="course-grid" aria-label="Available courses">
        ...
        <a className="course-card os-course" href="#/student/csc139/dashboard"><div className="course-card-top"><span>CSC 139</span><i>UPDATED</i></div><div className="course-art os-art"><span>USER</span><b>KERNEL</b><span>HARDWARE</span></div><div className="course-card-copy"><small>OPERATING SYSTEM PRINCIPLES</small><h2>Trust the<br/>kernel.</h2><p>Prof. Tarek Sakakini · Chapters 1-2</p></div><span className="course-launch">Open OS Lab <Icon name="arrow"/></span></a>
      </section>
    </main>
  </div>
}
