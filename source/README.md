...
Student progress is stored independently in the browser under `csc138-progress-v1` and `csc139-progress-v1`. Chapter 1 content for each course follows its uploaded lecture deck; later modules remain provisional until additional course materials are available.
